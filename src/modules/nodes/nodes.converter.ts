...
const entityToModel = (entity: NodesEntity): Nodes => {
    return {
        ...
        tags: entity.tags,
        expectedAgentVersion: entity.expectedAgentVersion,
        expectedAgentImageTag: entity.expectedAgentImageTag,
        rolloutBatch: entity.rolloutBatch,
        nodeApiSniEnabled: entity.nodeApiSniEnabled,
        nodeApiSniLastSuccessAt: entity.nodeApiSniLastSuccessAt,
        ips: entity.ips,
        geocheckIntervalMinutes: entity.geocheckIntervalMinutes,
        geocheckSource: entity.geocheckSource,
        geocheckCooldownMinutes: entity.geocheckCooldownMinutes,
        lastGeocheckScheduledAt: entity.lastGeocheckScheduledAt,
