...
export const REST_API = {
    ...
    BANDWIDTH_STATS: {
        ...
        USERS: {
            ...
            GET_HOSTS_BY_UUID: (uuid: string) =>
                `${ROOT}/${CONTROLLERS.BANDWIDTH_STATS_CONTROLLER}/${CONTROLLERS.BANDWIDTH_STATS_USERS_ROUTE}/${CONTROLLERS.BANDWIDTH_STATS_ROUTES.USERS.GET_HOSTS_BY_UUID(uuid)}`,
        },
        LEGACY: {
            NODES: {
                GET_USERS: (uuid: string) =>
