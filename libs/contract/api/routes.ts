...
export const REST_API = {
    MANAGEMENT: {
        SEARCH: `${ROOT}/${CONTROLLERS.MANAGEMENT_CONTROLLER}/${CONTROLLERS.MANAGEMENT_ROUTES.SEARCH}`,
        TAGS: (type: string) =>
            `${ROOT}/${CONTROLLERS.MANAGEMENT_CONTROLLER}/${CONTROLLERS.MANAGEMENT_ROUTES.TAGS(type)}`,
        ENTITY_TAGS: (type: string, uuid: string) =>
            `${ROOT}/${CONTROLLERS.MANAGEMENT_CONTROLLER}/${CONTROLLERS.MANAGEMENT_ROUTES.ENTITY_TAGS(type, uuid)}`,
    },
    AUTH: {
    ...
    NODES: {
        ...
        OBSERVABILITY: {
            GET: (uuid: string) =>
                `${ROOT}/${CONTROLLERS.NODES_CONTROLLER}/${CONTROLLERS.NODES_ROUTES.OBSERVABILITY.GET(uuid)}`,
            UPDATE_GEOCHECK: (uuid: string) =>
                `${ROOT}/${CONTROLLERS.NODES_CONTROLLER}/${CONTROLLERS.NODES_ROUTES.OBSERVABILITY.UPDATE_GEOCHECK(uuid)}`,
            ACK_DRIFT: (uuid: string, eventId: string) =>
                `${ROOT}/${CONTROLLERS.NODES_CONTROLLER}/${CONTROLLERS.NODES_ROUTES.OBSERVABILITY.ACK_DRIFT(uuid, eventId)}`,
        },
        TAGS: {
    ...
    SUBSCRIPTION_TEMPLATE: {
        ...
        ACTIONS: {
            PREVIEW_HOST: `${ROOT}/${CONTROLLERS.SUBSCRIPTION_TEMPLATE_CONTROLLER}/${CONTROLLERS.SUBSCRIPTION_TEMPLATE_ROUTES.ACTIONS.PREVIEW_HOST}`,
    ...
    NODE_PLUGINS: {
        ...
        ACTIONS: {
            ...
            PREVIEW: `${ROOT}/${CONTROLLERS.NODE_PLUGINS_CONTROLLER}/${CONTROLLERS.NODE_PLUGINS_ROUTES.ACTIONS.PREVIEW}`,
        },
        STATUS: (uuid: string) =>
            `${ROOT}/${CONTROLLERS.NODE_PLUGINS_CONTROLLER}/${CONTROLLERS.NODE_PLUGINS_ROUTES.STATUS(uuid)}`,
        ...
        SHARED_LISTS: {
            ...
            REFERENCES: (name: string) =>
                `${ROOT}/${CONTROLLERS.NODE_PLUGINS_CONTROLLER}/${CONTROLLERS.NODE_PLUGINS_ROUTES.SHARED_LISTS.REFERENCES(name)}`,
        },
        TORRENT_BLOCKER: {
    ...
    BANDWIDTH_STATS: {
        ...
        HOSTS: {
            GET: `${ROOT}/${CONTROLLERS.BANDWIDTH_STATS_CONTROLLER}/${CONTROLLERS.BANDWIDTH_STATS_HOSTS_ROUTE}/${CONTROLLERS.BANDWIDTH_STATS_ROUTES.HOSTS.GET}`,
            GET_USERS: (uuid: string) =>
                `${ROOT}/${CONTROLLERS.BANDWIDTH_STATS_CONTROLLER}/${CONTROLLERS.BANDWIDTH_STATS_HOSTS_ROUTE}/${CONTROLLERS.BANDWIDTH_STATS_ROUTES.HOSTS.GET_USERS(uuid)}`,
        },
        USERS: {
            GET: `${ROOT}/${CONTROLLERS.BANDWIDTH_STATS_CONTROLLER}/${CONTROLLERS.BANDWIDTH_STATS_USERS_ROUTE}/${CONTROLLERS.BANDWIDTH_STATS_ROUTES.USERS.GET}`,
            GET_BY_ID: (userId: string) =>
            ...
            GET_HOSTS_BY_ID: (userId: string) =>
                `${ROOT}/${CONTROLLERS.BANDWIDTH_STATS_CONTROLLER}/${CONTROLLERS.BANDWIDTH_STATS_USERS_ROUTE}/${CONTROLLERS.BANDWIDTH_STATS_ROUTES.USERS.GET_HOSTS_BY_ID(userId)}`,
        },
        INTERNAL_SQUADS: {
